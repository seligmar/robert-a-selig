...
export default function multimedia() {
  return (
    <>
      <PageLayout>
        <h2>Multi-Media Video Presentations</h2>
        VIDEO PRESENTATIONS: Waging War in America, 1775-1783: Operational
        Challenges of Five Armies. Panel discussion hosted by the American
        Revolution Institute of The Society of the Cincinnati on 1 August 2024:
        https://www.youtube.com/watch?v=yoAHlGDjINI Rochambeau at Morven:
        https://youtu.be/nkx64Q5ACgc The March to Yorktown:
        ...
        https://youtu.be/r0qGvd2P7qI Five podcasts in the series Amazing Tales
        from Off and On Connecticut‘s Beaten Path broadcast by Mike Allen:
