  ...
  return (
    <>
      ...
      <div className='home-content'>
        ...
        number of books on the American War of Independence such as Hussars in
        Lebanon! A Connecticut Town and Lauzun’s Legion during the American
        Revolution, 1780-1781 (Lebanon, 2004) and a translation of A Treatise on
        Partisan Warfare by Johann von Ewald. Introduction and Annotation by
        Robert A. Selig and David Curtis Skaggs (Westport, 1991).
      </div>
      <div className='home-content'>
        ...
        historian to the National Park Service for the Washington-Rochambeau
        Revolutionary Route National Historic Trail Project. For this project he
      ...
      <div className='home-content'>
        He also served and serves as Project Historian for American Battlefield
        Protection Program projects such as the “Battle of Princeton”, “Battle
        of Green Spring and Spencer’s Ordinary”, the “Paoli Massacre”, “Battle
        of the Clouds”, “Battle of Red Bank”, “Battle of Bennington”, “Battle of
        Hubbardton” and the “Battle of Brandywine”.
      </div>
      <div className='home-content'>
        He has been a regular contributor to German Life magazine for over 20
