    ...
    <>
      <PageLayout>
        ...
        <div className='home-content'>
          ...
          history from the Universität Würzburg in Germany in 1988. He published
          a number of books on the American War of Independence such as{' '}
          ...
          <i>A Treatise on Partisan Warfare</i> by Johann von Ewald,
          Introduction and Annotation by Robert A. Selig and David Curtis Skaggs
          (Westport, 1991).
        </div>
        <div className='home-content'>
          ...
          inventories for the states of New Hampshire, Rhode Island,
          Connecticut, New York, New Jersey, Pennsylvania, Delaware, Maryland,
          the District of Columbia and Virginia through which American and
          French forces marched in 1781 and 1782. These reports are available on
          the internet at: <a>https://w3r-us.org/history-by-state/.</a>
        </div>
        <div className='home-content'>
          ...
          projects such as the “Battle of Princeton”, “Battle of Green Spring
          and Spencer’s Ordinary”, the “Paoli Massacre”, “Battle of the Clouds”,
          “Battle of Red Bank”, “Battle of Bennington”, “Battle of Hubbardton”
